        ...
        <section className="relative pt-10 pb-8 md:py-[72px] lg:pb-[100px] xl:pb-[128px]">
            <div className="ml-3">
                <div className="flex flex-col-reverse items-center text-center gap-2.5 mb-8 md:gap-4 md:mb-10 lg:gap-5 lg:mb-12">
                    ...
                    <h2 className="text-sm leading-none tracking-[-0.41px] text-[#5b5b5e] md:text-base md:leading-none lg:text-xl lg:leading-none dark:text-slate-200">Bosen denger lagu yang itu-itu aja?</h2>
                </div>
